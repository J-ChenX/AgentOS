...
export default function ErrorCard({ message, recoverable }: { message: string; recoverable: boolean }) {
  return (
    <div
      style={{
      ...
      <div>
        <div
          style={{
            ...
            fontWeight: 500, color: 'var(--color-error)',
          }}
        >
          错误
        </div>
        <div
          style={{
            ...
            marginTop: '2px', lineHeight: 'var(--leading-normal)',
          }}
        >
          {message}
        </div>
