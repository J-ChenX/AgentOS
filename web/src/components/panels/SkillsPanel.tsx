      ...
      {skills.map((skill) => (
        ...
        >
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div
              style={{
                fontSize: '11px', fontWeight: 300, color: 'var(--color-ink-tertiary)',
          ...
          <label style={{ position: 'relative', display: 'inline-flex', alignItems: 'center', cursor: 'pointer', marginLeft: '12px', flexShrink: 0 }}>
            <input
              type="checkbox"
